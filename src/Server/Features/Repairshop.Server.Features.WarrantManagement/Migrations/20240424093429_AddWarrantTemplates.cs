        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WarrantTemplateId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WarrantTemplateSteps_WarrantTemplates_WarrantTemplateId",
                        column: x => x.WarrantTemplateId,
                        principalSchema: "wm",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WarrantTemplateSteps_WarrantTemplateId",
                schema: "wm",
                table: "WarrantTemplateSteps",
                column: "WarrantTemplateId");
        }
